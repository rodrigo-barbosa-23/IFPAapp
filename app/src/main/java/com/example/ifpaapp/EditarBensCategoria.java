...
public class EditarBensCategoria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.editar_bens_categoria);
        ...
        alterar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (codigo.getText().toString().trim().equals("")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditarBensCategoria.this);
                    ...
                    Intent intent = new Intent(EditarBensCategoria.this, ConsultarBensPorCategoria.class);
